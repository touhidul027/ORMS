	...
	<!-- Including the header -->
		<jsp:include page="homePageHeader.html"></jsp:include>
				...
				<div class="card" style="width: 400px;text-align:center ;  margin: 0 auto ; margin-top:30px ; ">
				  <div class="card-body">
					<h5 class="card-title"><%= request.getAttribute("loginInformation") %></h5>
					<h6 class="card-subtitle mb-2 text-muted">${requestScope.missingThing}</h6>
					<p class="card-text">${requestScope.loginInformationMissingThingmessage}</p>
					<a href="index.jsp" class="card-link">Home page</a>
					<a href="signIn.jsp" class="card-link">Try Again</a>
				   <a href="signUp.jsp" class="card-link">Sign Up</a>
									  </div>
				</div>	
